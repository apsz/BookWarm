...
class BookWarmClient(asyncio.Protocol):
    ...
    def _books_menu_options(self):
        ...
        if user_choice == 'b':
            ...
            self._send_formatted(command=user_choice, client_data='',
                                 options_menu='collections_menu', next_menu='collections_menu')
    ...
    def _send_formatted(self, command, client_data, options_menu,
                        next_menu, format='{}  {}  {}  {}'):
        self._write(format.format(command, client_data, options_menu, next_menu))
